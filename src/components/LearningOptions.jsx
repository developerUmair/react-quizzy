...
const LearningOptions = () => {
  return (
    <div style={{ backgroundImage: `url(${texture})` }} className="bg-cover bg-center bg-no-repeat">
      
      <section className="relative py-16 bg-[#dbac66] bg-opacity-50">
        ...
        <div className="relative mx-auto max-w-6xl px-4 sm:px-6 lg:px-6 md:py-14">
          {/* Tilted Background */}
          <div className="absolute inset-0 bg-secondary opacity-100 rounded-3xl md:transform md:rotate-1 z-0"></div>
